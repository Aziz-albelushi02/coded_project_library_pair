...
class MembersListPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title:
            Text("Members List", style: Theme.of(context).textTheme.titleMedium),
        centerTitle: true,
              ...
              child: Row(
                ...
                Column(
                  ...
                  children: [
                    ...
                    Text("Membership Tier", style: Theme.of(context).textTheme.titleSmall,),
                    Container(
                      margin: EdgeInsets.only(top: 5),
                      child: Text("borrowd: 5 books", style: Theme.of(context).textTheme.bodySmall)
                      ),
                  ],
                )
              ]),
